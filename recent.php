...
if(count($errors) === 0){
	...
	try{
		...
		$statement = $dbh->prepare("SELECT * FROM univ_data WHERE DATE_ADD(date_renew, INTERVAL 30 DAY) > CURDATE() ORDER BY date_renew DESC; ");
...
<html>
	<head>
		<title>最近更新されたページ　-　KGK Japan info</title>
		<meta charset="utf-8" />
